...
public class EditUserTest {
    ...
    public void editUserWithLoginPassed() {
        ...
        Response editUserResponse = UserApi.editUserInfoWithLogin(userToken, new UserData(EMAIL, NAME));
    ...
    public void editUserWithoutLoginPassed() {
        Response editUserResponse = UserApi.editUserInfoWithoutLogin(new UserData(EMAIL, NAME));
        editUserResponse.then()
                .statusCode(401)
                .assertThat()
